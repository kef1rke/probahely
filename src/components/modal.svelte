<script>
	import noModal from '../components/calendar.svelte';
</script>

<div class=" z-10  fixed w-full h-full top-0 left-0">
	<div class="flex justify-center h-screen items-center bg-gray-600 bg-opacity-60 antialiased">
		<div
		...
		>
			...
			<div class="flex flex-col px-6 py-5 bg-gray-50">
				...
				<div class="flex items-center mt-5 mb-3 space-x-4">
					...
					<label class="inline-flex font-semibold text-gray-400" for="check1"> Add a crew</label><br
					/>
			...
			>
				<button on:click={noModal} class="font-semibold text-gray-600">Cancel</button>
				<button class="px-4 py-2 text-white font-semibold bg-blue-500 rounded"> Save </button>
			</div>
		</div>
	</div>
</div>
